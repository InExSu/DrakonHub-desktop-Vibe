(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module) {
    ...
    }, { "./drakonToStruct": 3, "./printPseudo": 5, "./tools": 8 }], 3: [function (require, module) {
        ...
        function rewireShortcircuit(nodes) {
            while (findShortcusts(nodes)) { /* empty */ }
        }
    ...
    }, { "./structFlow": 6, "./tools": 8 }], 4: [function (require) {
    ...
    }, { "./browserTools": 1, "./drakonToPromptStruct": 2, "./drakonToStruct": 3, "./translate": 9 }], 5: [function (require, module) {
        ...
        function printPseudo(algorithm, translate, output, htmlToString) {
            ...
            function printStructuredContentNoIdent(content) {
                ...
                if (typeof content === "string") {
                    ...
                    operator = translate(content.operator)
    ...
    }, { "./tools": 8 }], 6: [function (require, module) {
        ...
        function structFlow(nodes, branches, filename, translate) {
            ...
            function structMain() {
                ...
                var result = []
                for (var brnch of branches) {
                    flowGraph(nodes, brnch.next, [])
                }
    ...
    }, { "./technicalTree": 7, "./tools": 8, "./treeTools": 10 }], 7: [function (require, module) {
